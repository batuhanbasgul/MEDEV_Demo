...
<div class="page-body">
    <div class="container-fluid">
      <div class="page-header">
        <div class="row">
          <div class="col-sm-12">
            <h3>{{__('company.create_company')}}</h3>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">{{__('company.company_info')}}</a></li>
              <li class="breadcrumb-item">{{__('company.create_company')}}</li>
            </ol>
          </div>
          <!--
          <div class="col-sm-6">
    ...
    <div class="container-fluid">
      <div class="edit-profile">
        <div class="row">
          <div class="col-xl-12">
            <form class="card needs-validation" novalidate="" action="{{ route('company-controller.store') }}" method="POST">
              @csrf
              <div class="card-header pb-0">
                <h4 class="card-title mb-0">{{__('company.create_company')}}</h4>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <input class="form-control" id="company_name" name="company_name" type="text" placeholder="{{__('company.company_name_placeholder')}}" value="{{ old('company_name') }}" required="required">
                      <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                    </div>
                  </div>
                <div class="card-footer text-end">
                <button class="btn btn-primary" id="create_company" name="create_company" type="submit">{{__('company.create_company')}}</button>
              </div>
            </form>
          </div>
        </div>
