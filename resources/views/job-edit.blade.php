        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">{{__('job.edit_job')}}</li>
            </ol>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="form theme-form">
                    <form class="needs-validation" novalidate="" action="{{ route('job-controller.update',$job->id) }}" method="POST">
                      @csrf
                      @method('PUT')
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input class="form-control" id="job_title" name="job_title" type="text" placeholder="{{__('job.job_title')}}" value="{{ $job->job_title }}" required="required">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="col-sm-12">
                              <div class="mb-3">
                                ...
                                placeholder="{{__('job.job_start_date')}}" data-alt-input="true" autocomplete="off" data-date-format="dd MM yyyy" data-alt-format="j F Y" value="{{ $job->start_date }}">
                                <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                              </div>
                          </div>
                          <div class="col-sm-12">
                              <div class="mb-3">
                                ...
                                placeholder="{{__('job.job_end_date')}}" data-alt-input="true" autocomplete="off" data-date-format="dd MM yyyy" data-alt-format="j F Y" value="{{ $job->end_date }}">
                                <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                              </div>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="mb-3">
                            ...
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                            <div class="invalid-feedback px-1">{{__('job.person _to_assign_error')}}</div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <textarea class="form-control" id="job_context" name="job_context" rows="8" placeholder="{{__('job.job_context_placeholder')}}" required="required">{{ $job->job_context }}</textarea>
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="text-end mt-2">
                            <button class="btn btn-primary" id="update_job" name="update_job" type="submit">{{__('constant.save')}}</button>
