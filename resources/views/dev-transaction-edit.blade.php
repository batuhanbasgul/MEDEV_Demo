        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">{{__('transaction.edit_technical_service_form')}}</li>
            </ol>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="form theme-form">
                    <form class="needs-validation" novalidate="" action="{{ route('dev-transaction-controller.update',$transaction->id) }}" method="POST">
                      @csrf
                      @method('PUT')
                      <div class="row">
                        <div class="row mb-3">
                          <div class="col col-12 col-sm-4 mt-3">
                            ...
                            <input class="form-control" id="corporation_name" name="corporation_name" type="text" placeholder="{{__('transaction.corporation_name_placeholder')}}" required="required" value="{{$transaction->corporation_name}}" readonly>
                          ...
                          <div class="col col-12 col-sm-4 mt-3">
                            ...
                            <input class="form-control" id="department_name" name="department_name" type="text" placeholder="{{__('transaction.department_name_placeholder')}}" required="required" value="{{$transaction->department_name}}" readonly>
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          ...
                          <div class="col col-12 col-sm-4 mt-3">
                            ...
                            <input class="form-control" id="device_name" name="device_name" type="text" placeholder="{{__('transaction.device_name_placeholder')}}" required="required" value="{{$transaction->device_name}}" readonly>
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          ...
                          <div class="col col-12 col-sm-4 mt-3">
                            ...
                            <input class="form-control" id="device_brand" name="device_brand" type="text" placeholder="{{__('transaction.device_brand_placeholder')}}" required="required" value="{{$transaction->device_brand}}" readonly>
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          ...
                          <div class="col col-12 col-sm-4 mt-3">
                            ...
                            <input class="form-control" id="device_model" name="device_model" type="text" placeholder="{{__('transaction.device_model_placeholder')}}" required="required" value="{{$transaction->device_model}}" readonly>
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          ...
                          <div class="col col-12 col-sm-4 mt-3">
                            ...
                            <input class="form-control" id="transactions" name="transactions" type="text" placeholder="{{__('transaction.transactions_placeholder')}}" required="required" value="{{ $transaction->transactions }}">
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          ...
                          <div class="col col-12 col-sm-4 mt-3">
                            ...
                            <select class="form-select digits" id="personel_id" name="personel_id" required="required">
                              ...
                              <option value="{{$item->id}}" @if ($transaction->personel_id == $item->id) selected @endif>{{$item->name}}</option>
                              @endforeach
                            </select>
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          ...
                          <div class="col col-12 col-sm-4 mt-3">
                            ...
                            <input class="form-control" id="record_no_to" name="record_no_to" type="text" placeholder="{{__('transaction.record_no_to_placeholder')}}" value="{{$transaction->record_no_to }}">
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          </div>
                          <div class="col col-12 col-sm-4 mt-3">
                            <label class="form-label" for="record_no_from">{{__('transaction.record_no_from')}}</label>
                            <input class="form-control" id="record_no_from" name="record_no_from" type="text" placeholder="{{__('transaction.record_no_from_placeholder')}}" value="{{$transaction->record_no_from}}">
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          </div>
                          <div class="col col-12 col-sm-4 mt-3">
                            <label class="form-label" for="calibration_tag_date">{{__('transaction.calibration_tag_date')}}</label>
                            <input class="form-control" id="calibration_tag_date" name="calibration_tag_date" type="text" placeholder="{{__('transaction.calibration_tag_date_placeholder')}}" value="{{$transaction->calibration_tag_date}}">
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          </div>
                          <div class="col col-12 col-sm-4 mt-3">
                            ...
                            placeholder="{{__('transaction.service_in_date_placeholder')}}" data-alt-input="true" autocomplete="off" data-date-format="dd MM yyyy" data-alt-format="j F Y" value="{{$transaction->service_in_date}}">
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          </div>
                          <div class="col col-12 col-sm-4 mt-3">
                            ...
                            placeholder="{{__('transaction.service_out_date_placeholder')}}" data-alt-input="true" autocomplete="off" data-date-format="dd MM yyyy" data-alt-format="j F Y" value="{{$transaction->service_out_date}}">
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          </div>
                          <div class="col col-12 mt-3">
                            <label class="form-label" for="note">{{__('transaction.note')}}</label>
                            <input class="form-control" id="note" name="note" type="text" placeholder="{{__('transaction.note_placeholder')}}" maxlength="100" value="{{ $transaction->note }}">
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          </div>
                          <div class="mt-3">
                            <label class="form-label p-0" for="description">{{__('transaction.description')}}</label>
                            <textarea class="form-control" id="description" name="description" rows="4" placeholder="{{__('transaction.description_placeholder')}}">{{$transaction->description}}</textarea>
                          </div>
                          <div class="col col-12 col-sm-6 mt-3">
                            <label class="form-label" for="verifier_name">{{__('transaction.verifier_name')}}</label>
                            <input class="form-control" id="verifier_name" name="verifier_name" type="text" placeholder="{{__('transaction.verifier_name_placeholder')}}" required="required" value="{{$transaction->verifier_name}}">
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                          ...
                          <div class="col col-12 col-sm-6 my-3">
                            ...
                            <input class="form-control" id="verifier_tel" name="verifier_tel" type="tel" pattern="[0-9]+" placeholder="{{__('transaction.verifier_tel_placeholder')}}" required="required" value="{{$transaction->verifier_tel}}">
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="text-end">
                            <button class="btn btn-primary" id="edit_transaction" name="edit_transaction" type="submit">{{__('constant.update')}}</button>
