        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">{{__('corporation.create_corporation')}}</li>
            </ol>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="form theme-form">
                    <form class="needs-validation" novalidate="" action="{{ route('corporation-controller.store') }}" method="POST">
                      @csrf
                      <div class="row">
                        <div class="col-12">
                          <div class="mb-3">
                            <label class="form-label" for="type">{{__('corporation.corp_name')}}</label><span class="text-danger">*</span>
                            <input class="form-control" id="name" name="name" type="text" placeholder="{{__('corporation.corp_name_placeholder')}}" required="required" value="{{ old('name') }}">
                      ...
                      <div class="row">
                        ...
                        <div class="col-6">
                          <div class="mb-3">
                            ...
                            <input class="form-control" id="province" name="province" type="text" placeholder="{{__('corporation.province_placeholder')}}" required="required" value="{{ old('province') }}">
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="text-end mt-2">
                            <button class="btn btn-primary" id="create_corporation" name="create_corporation" type="submit">{{__('corporation.create_corporation')}}</button>
                            <a class="btn btn-danger" href="{{route('corporation-controller.index')}}">{{__('constant.back')}}</a>
                          </div>
                        </div>
                      </div>
                    </form>
