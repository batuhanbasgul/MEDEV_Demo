        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">{{__('product.create_product')}}</li>
            </ol>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="form theme-form">
                    <form class="needs-validation" novalidate="" action="{{ route('product-controller.store') }}" method="POST">
                      @csrf
                      <div class="row">
                        <div class="row mb-3">
                      ...
                      <div class="row">
                        <div class="col col-12 col-md-6 col-xl-6">
                          <div class="mb-3">
                            ...
                            <input class="form-control" id="name" name="name" type="text" required="required" placeholder="{{__('product.product_name_placeholder')}}" value="{{ old('name') }}">
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                        ...
                        <div class="col col-12 col-md-6 col-xl-6">
                          <div class="mb-3">
                            <label class="form-label" for="device_count">{{__('product.device_count')}}</label><span class="text-danger">*</span>
                            <input class="form-control" id="device_count" name="device_count" type="number" min="0" placeholder="{{__('product.device_count_placeholder')}}" required="required" value="{{ old('device_count') }}">
                            <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                            <div class="invalid-feedback px-1">{{__('product.device_count_error')}}</div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select class="form-select digits"  id="start_date_month" name="start_date_month" required="required">
                                      ...
                                      <option value="1">{{__('product.january')}}</option>
                                      <option value="2">{{__('product.february')}}</option>
                                      <option value="3">{{__('product.march')}}</option>
                                      <option value="4">{{__('product.april')}}</option>
                                      <option value="5">{{__('product.may')}}</option>
                                      <option value="6">{{__('product.june')}}</option>
                                      <option value="7">{{__('product.july')}}</option>
                                      <option value="8">{{__('product.august')}}</option>
                                      <option value="9">{{__('product.september')}}</option>
                                      <option value="10">{{__('product.october')}}</option>
                                      <option value="11">{{__('product.november')}}</option>
                                      <option value="12">{{__('product.december')}}</option>
                                    </select>
                                    <div class="valid-feedback px-1">{{__('constant.looks_good')}}</div>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="text-end mt-2">
                            <button class="btn btn-primary" id="create_product" name="create_product" type="submit">{{__('product.create_product')}}</button>
